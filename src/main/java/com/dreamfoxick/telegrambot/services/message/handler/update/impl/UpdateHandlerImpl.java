  ...
  private void processUpdate(Message message,
    ...
    try {
      if (isTextMessage(message)) {
        processMessage(chatId, text, bot);
      } else {
      ...
      exceptionProcessor.processIllegalArgumentException(chatId, iae, bot);
    } catch (JsonMappingException jme) {
      exceptionProcessor.processJsonMappingException(chatId, jme, bot);
    } catch (Exception e) {
